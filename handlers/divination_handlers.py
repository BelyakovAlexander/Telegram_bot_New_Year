...
divination_list = ('В новом году тебя ждет много радостных моментов и приятных сюрпризов!',
                   ...
                   'Сбудется мечта, о которой ты давно забыл, и подарит новые краски жизни.',
                   '2025 год подарит тебе людей, с которыми смех станет слаще, а тишина теплее',
                   'Этот год словно чистое полотно — возьми кисти смелее и рисуй жизнь, о которой мечтал.',
                   'Тебе предстоит увидеть мир с новой стороны. Открой своё сердце, чтобы идти навстречу переменам!',
                   'Новый год откроет двери, которые ты искал долго, и за ними будет то, к чему ты шёл.',
                   'На твой путь ляжет свет новой звезды, следуй за ней, и она приведёт тебя к счастью.',
                   'Год впереди — время улыбок и мудрости. Пусть каждая встреча будет шагом к твоей мечте!',
                   'Тепло, которое ты даришь, вернётся к тебе с нежностью весеннего ветра.',
                   'Этот год принесет тебе новые удивительные открытия! Держи глаза и сердце открытыми для маленьких чудес вокруг!',
                   'Каждый в этом году найдёт новое увлечение, которое раскроет его талант и принесёт радость.',
                   'Этот год — год крепкой дружбы. Жди новых друзей и добрых встреч!',
                   'Каждому в семье достанется по-маленькому, но важному подарку от судьбы, так что будь готов к сюрпризам.',
                   'В 2025 году твой дом наполнится смехом, радостью и множеством новых достижений.',
                   'Этот год научит тебя вместе побеждать любые трудности, делая семью еще сильнее и дружнее.',
                   'В 2025 году удача станет твоим постоянным спутником, помогая в важных начинаниях и неожиданных поворотах.',
                   'Пришло время получить заслуженные плоды ваших трудов — в этом году тебя ждут приятные успехи!',
                   'В этом году ты ощутишь истинную поддержку близких людей, и это станет твоей силой.',
                   'В 2025 году ты откроешь в себе новый талант, который принесет вдохновение и новые перспективы.',
                   'Этот год наполнит твою жизнь гармонией, позволяя найти баланс между работой и личным счастьем.'
                   )
